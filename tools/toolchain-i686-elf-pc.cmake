...
find_program(CROSS_OBJDUMP NAMES i686-elf-objdump PATHS ${CROSSCOMPILE_PATH})

if (NOT CROSS_OBJDIR OR NOT CROSS_OBJDUMP)
    message(FATAL_ERROR "Cannot continue without required binaries")
endif()
